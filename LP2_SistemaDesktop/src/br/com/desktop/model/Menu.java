...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Relatórios", Model_Menu.TipoMenu.MENU));
        listMenu1.addItem(new Model_Menu("3", "Comonents", Model_Menu.TipoMenu.MENU));
        listMenu1.addItem(new Model_Menu("4", "Forms Stuff", Model_Menu.TipoMenu.MENU));
        ...
        listMenu1.addItem(new Model_Menu("7", "Equipes", Model_Menu.TipoMenu.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(Menu.class.getResource("/br/com/desktop/image/logoTaskMaster48.png"))); // NOI18N
